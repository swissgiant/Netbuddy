...
import type { Credential, Device, DeviceCreate, Site, SuggestedDevice } from "../api";
import {
  createDevice,
  deleteDevice,
  fetchAdapters,
  ...
  return (
    <div className="content">
      ...
      <div className="card">
        ...
        <table>
          <thead>
            <tr><th>Hostname</th><th>IP</th><th>Typ</th><th>Vendor</th><th>Adapter</th><th>Modell</th><th>Standort</th><th></th></tr>
          </thead>
          <tbody>
            {devices.map((d) => (
              <tr key={d.id}>
